 ...
 * @returns
 */
function toDateString(startDate:Date|number,endDate:Date|number,separator:string){
...
function defaultDate(type: string,separator:string) {
  ...
  let startDate = type=='currentMonth'?date:type=='threeMonth'?beforeThreeMonthDay:beforeYearDay
